...
<script type="text/javascript">
	...
	var tabledata = [
	{id:4, "destination":"red", created_at:""},
	{id:3, "destination":"green", created_at:""},
	{id:2, "destination":"blue", created_at:""},
	{id:1, "destination":"orange", created_at:""},
	];
...
<section>
	...
	<script type="text/javascript">
		...
		var printIcon = function(value, data, cell, row, options){ //plain text value
			...
			// setTimeout(function(){
			// 	$(".table").tabulator("setGroupBy", "description");
			// 	setTimeout(function(){
			// 		$(".table").tabulator("setGroupBy", false);
			// 		setTimeout(function(){
			// 			$(".table").tabulator("setGroupBy", "destination");
			// 			setTimeout(function(){
			// 				$(".table").tabulator("setGroupBy", "aaa");
			// 			}, 2000);
			// 		}, 2000);
			// 	}, 2000);
			// }, 2000);
			...
			$(".table").tabulator({
				height:"100%",
				           ...
				           columns:[
				               {title:"Skill", field:"destination", minWidth:120},
				               {title:"Recorded At", field:"created_at", sorterParams:{format: "DD/MM/YY hh:mm:ss"}, minWidth:140, responsive:5},
				               {
				                   title:"Round 1",
				                   columns:[
				                       {title:"Speed", field:"rounds.1.speed", minWidth:90, formatter:"money", formatterParams:{precision:2,symbolAfter:true,symbol:' mph'}, responsive:9},
				                       {title:"Accuracy", field:"rounds.1.speed", minWidth:100, formatter:"money", formatterParams:{precision:2,symbolAfter:true,symbol:'%'}, responsive:9},
				                   ],
				               },
				               {
				                   title:"Round 2",
				               ...
				               },
				               {
				                   title:"Best",
				                   columns:[
				                       {title:"Speed", field:"speed", minWidth:90, formatter:"money", formatterParams:{precision:2,symbolAfter:true,symbol:' mph'}, responsive:7},
				                       {title:"Accuracy", field:"accuracy", minWidth:100, formatter:"money", formatterParams:{precision:2,symbolAfter:true,symbol:'%'}, responsive:7},
				                       {title:"Score", field:"score", minWidth:100, formatter:"money", formatterParams:{precision:2,symbolAfter:true,symbol:'%'}},
				                   ],
				               },
