    ...
    (0, _multistream2.default)(function (cb) {
      if (count === 0) {
        ...
        if (stripes.length) {
          ...
          return cb(undefined, next((0, _simpleBufferstream2.default)(makePreludeBufferFromPrelude(replaceDollarWise(replaceDollarWise(prelude, '%VIRTUAL_FILESYSTEM%', (0, _stringify2.default)(vfs)), '%DEFAULT_ENTRYPOINT%', (0, _stringify2.default)(entrypoint))))));
        }
      } else {
        return cb();
      }
